...
// Boton de eventos de las listas
...
// Búsqueda por envío de formulario
searchForm.addEventListener('submit', getInputValue);

// Autenticación de la página de superheroes porque solicita un token => 2384885355028935
const fetchAllSuperHero = async(searchText) => {
    let url = `https://www.superheroapi.com/api.php/2384885355028935/search/${searchText}`;
    try{
 ...
 //Constante de la búsqueda al colocar el nombre del superheroe
...
// Datos detallados de los superheroes (Habilidad, fuerza, etc.)
